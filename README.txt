#Migrated to git on Feb/18/2014
git svn clone --authors-file users.txt --no-metadata svn://blake/jms-examples jms-examples
git filter-branch --tree-filter 'rm -f src/main/resources/images/*.jpg' HEAD

*It failed because a missing dependencies of activemq plugin, of groupId net.sf.josql.
*So either those dependencies disappeared from maven central repository or maven 3(maven 2 was used to create this
project I suppose) is less tolerant for optional dependencies as marked in activemq-parent-5.3.X pom.
*It was fixed upgrading maven-activemq-plugin to 5.6.0
*The interesting part here is the "Loteria" game simulator
